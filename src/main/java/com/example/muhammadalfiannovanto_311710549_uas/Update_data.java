...
public class Update_data extends AppCompatActivity {
    EditText id_barang, kode_barang, nama_barang, size, jumlah;
    Button simpan_data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(Update_data.this);
    ...
    public void CreateDataToServer(final String kode_barang, final String nama_barang,final String size, final String jumlah) {
        if (checkNetworkConnection()) {
            progressDialog.show();
            StringRequest stringRequest= new StringRequest(Request.Method.POST, Contract.SERVER_EDIT,
                            ...
                            try {
                                ...
                                if(resp.equals("[{\"status\":\"OK\"}]"))
                                {
                                    ...
                                    AlertDialog.Builder builder=
                                            new AlertDialog.Builder(Update_data.this);
                                    builder.setTitle("Sukses");
                                    builder.setMessage("Data Berhasil Di Update");
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("id_barang", getIntent().getStringExtra("id_barang"));
            ...
            VolleyConnection.getInstance(Update_data.this).addToReuestQue(stringRequest);
